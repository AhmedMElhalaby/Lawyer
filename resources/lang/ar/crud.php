...
return [
    ...
    'LawArticle'=>[
        ...
        'crud_name' => 'مادة',
        'crud_the_name' => 'المادة',
        'name' => 'الاسم انجليزي',
        'name_ar' => 'الاسم عربي',
        'law_id' => 'القانون',
        'text' => 'نص المادة انجليزي',
        'text_ar' => 'نص المادة عربي',
    ],
    'LawArticleTag'=>[
        'crud_names' => 'الكلمات المفتاحية للقوانين',
        'crud_name' => 'كلمة مفتاحية',
        'crud_the_name' => 'الكلمة المفتاحية',
        'name' => 'الكلمة',
        'law_id' => 'القانون',
